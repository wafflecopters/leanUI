 ...
 * - η-conversion: optional (todo)
 * 
 * For now, delegates to structural equality.
 * TODO: Add normalization before comparison.
 */
export function areTypesDefEq(t1: TTerm, t2: TTerm): boolean {
  // TODO: Normalize both terms before comparing
  // For now, just use structural equality
  return isDefinitionallyEqual(t1, t2);
}
