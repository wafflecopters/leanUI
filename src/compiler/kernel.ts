 ...
 * - PVar: binds a variable (wildcards are PVar with _wN names)
 * - PCtor: matches a constructor with sub-patterns
 *
 * There is no PWild type - wildcards are represented as PVar with unique names
 * like _w0, _w1 generated by the parser.
 */
