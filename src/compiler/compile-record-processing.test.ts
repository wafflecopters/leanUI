...
describe('compile-record-processing', () => {
  ...
  test('substituteInheritedFieldRefs leaves rational literals untouched', () => {
    const ratLiteral = { tag: 'RatLit', num: 3n, den: 5n } as any;
    expect(substituteInheritedFieldRefs(ratLiteral, ['op'], 0)).toBe(ratLiteral);
  });
